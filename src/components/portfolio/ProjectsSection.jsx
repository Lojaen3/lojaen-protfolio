...
const projects = [
  ...
  },
  {
    title: "Budgie",
    description:
      "An app that helps adults with irregular spending maintain financial stability and consistency by categorizing income, automated transaction tracking, and providing real-time spending insights.",
    technologies: [
      "SwiftUI",
      "SwiftData",
      "LocalAuthentication",
    ...
    github: null,
    live: "https://apps.apple.com/sa/app/budgie-money-tracking-app/id6773916915",
    image: publicUrl("/projects/budgie.png"),
    imageClass: "object-contain object-top p-2 md:p-3",
    imageNoZoom: true,
    imageIndex: 8,
  },
  {
    title: "Water and Ice",
    description:
      "Water and Ice is an online multiplayer game built on teamwork and competition between two teams: Team Water and Team Ice. Create private rooms, join friends with a game code, and face off in fast-paced rounds where the Ice team freezes players and the Water team rescues their frozen teammates.",
    technologies: [
      "Unity",
      "C#",
      "Netcode",
    ...
    github: null,
    live: "https://apps.apple.com/sa/app/%D9%84%D8%B9%D8%A8%D8%A9-%D9%85%D9%88%D9%8A%D8%A9-%D9%88%D8%AB%D9%84%D8%AC/id6776682381",
    image: publicUrl("/projects/watericegame.jpg"),
    imageClass: "object-contain object-top p-2 md:p-3",
    imageNoZoom: true,
    imageIndex: 9,
  },
